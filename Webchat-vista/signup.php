<?php
  ...
  if (!empty($_POST['nameUser']) && !empty($_POST['email']) && !empty($_POST['password'])) {
    $sql = "INSERT INTO user(nameUser, email, passwordUser) VALUES (:nameUser, :email, :password)";
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<input name="nameUser" type="text" class="form-control" placeholder="Nickname">
									</div>
                  					<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="submit" class="btn btn-primary btn-md" value="Registrarse">
