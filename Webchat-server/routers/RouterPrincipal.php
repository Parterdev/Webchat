   ...
   function route(){
      switch(strtolower($this->datosURI->controlador)){
         ...
         case "passworduser":
            ...
            break;
         case "typeaccount":
            $routerTypeAccount = new RouterTypeAccount();
            return json_encode($routerTypeAccount->route());
            break;
         case "typelounge":
         ...
         case "useraccount":
            ...
            break;
         case "usertype":
            $routerUserType = new RouterUserType();
            return json_encode($routerUserType->route());
            break;
         default:
